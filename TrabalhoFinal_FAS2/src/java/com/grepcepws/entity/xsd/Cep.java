...
public class Cep {
    ...
    @XmlElementRef(name = "bairro", namespace = "http://entity.grepcepws.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> bairro;
    @XmlElementRef(name = "cep", namespace = "http://entity.grepcepws.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> cep;
    @XmlElementRef(name = "cidade", namespace = "http://entity.grepcepws.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> cidade;
    @XmlElementRef(name = "estado", namespace = "http://entity.grepcepws.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> estado;
    @XmlElementRef(name = "id", namespace = "http://entity.grepcepws.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> id;
    @XmlElementRef(name = "latitude", namespace = "http://entity.grepcepws.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> latitude;
    @XmlElementRef(name = "logradouro", namespace = "http://entity.grepcepws.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> logradouro;
    @XmlElementRef(name = "longitude", namespace = "http://entity.grepcepws.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> longitude;
    @XmlElementRef(name = "regiao", namespace = "http://entity.grepcepws.com/xsd", type = JAXBElement.class, required = false)
