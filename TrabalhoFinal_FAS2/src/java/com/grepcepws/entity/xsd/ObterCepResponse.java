...
@XmlType(name = "ObterCepResponse", propOrder = {
    "cepList",
    "responseCode",
    "responseDescription",
    "transactionId"
...
public class ObterCepResponse {
    ...
    @XmlElementRef(name = "responseCode", namespace = "http://entity.grepcepws.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> responseCode;
    @XmlElementRef(name = "responseDescription", namespace = "http://entity.grepcepws.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> responseDescription;
    @XmlElementRef(name = "transactionId", namespace = "http://entity.grepcepws.com/xsd", type = JAXBElement.class, required = false)
